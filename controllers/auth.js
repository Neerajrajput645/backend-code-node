...
//   const findService = await Service.findOne({ name: "SIGNUP" });
...
//         res.status(400);
//         throw new Error(
//           "Multiple signups from the same device are not allowed."
//         );
//       }
...
//       //     txnDesc: `You got referal bonus ₹${GET_REFER_AMOUNT.referAmount}.`,
//       //     txnAmount: 5,
//       //     txnType: "credit",
//       //     txnId: Math.floor(Math.random() * Date.now()) + "txnb",
//       //     orderId: Math.floor(Math.random() * Date.now()) + "b",
